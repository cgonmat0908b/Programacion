...
public class PrincipalViviendaTuristica {
	...
	public static void main(String[] args) {
		...
		Apartamento defecto = new Apartamento();
		...
		float precioNoche = (float) (datos.real());
		
		System.out.println("Introduce la distancia al centro");
		byte distCentro = (byte) (datos.entero());
		
		Apartamento noche = new Apartamento(precioNoche, distCentro);	
		
		//4. Calcula el precio para una estancia de 5 días.
		// Evidencia: el precio de la estancia.
		noche.precioEstancia(5);
